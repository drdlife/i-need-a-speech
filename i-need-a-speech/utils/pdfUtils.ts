...
export const generatePDF = (speech: GeneratedSpeech) => {
  ...
  const splitTitle = doc.splitTextToSize(speech.title, 180); doc.text(splitTitle, 15, 20);
  ...
  doc.setFontSize(8); doc.setTextColor(150); doc.text(`Generated by "I Need a Speech"`, 15, pageHeight - 10);
