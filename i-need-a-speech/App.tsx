  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-gray-900 bg-gray-50 dark:bg-gray-950 dark:text-gray-100 transition-colors duration-300">
      ...
      <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-50 transition-colors duration-300">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              onClick={toggleTheme} 
              className="p-2 text-gray-500 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400 rounded-lg transition-colors"
          ...
          <div className="w-full flex flex-col items-center animate-in fade-in duration-700">
            <div className="text-center mb-10 max-w-2xl">
              <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-900 dark:text-white mb-6 tracking-tight">
                Perfect speeches, <br/>
                <span className="text-indigo-600 dark:text-indigo-400">written instantly.</span>
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                Whether it's a wedding toast, a eulogy, or a class presentation, 
                get a personalized speech in seconds. Download as PDF, or listen to a lifelike AI narration.
              </p>
            </div>
            <InputForm 
              isLoading={status === 'generating_text'} 
              onSubmit={handleSpeechRequest} 
            />
          </div>
        )}
      </main>
      ...
      <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 py-8 transition-colors duration-300">
        <div className="max-w-6xl mx-auto px-4 text-center text-gray-400 dark:text-gray-500 text-sm">
          &copy; {new Date().getFullYear()} I Need a Speech. All rights reserved.
        </div>
      </footer>
    </div>
  );
